...
exports['forOf!!'] = function(exp, env) {
  ...
  return ['jsForIn!', key1, convert(obj, env), convert(body, env)];
};
...
exports['forIn!!'] = function(exp, env) {
  var body, index, item, length, range, result;
...
exports['forIn!'] = function(exp, env) {
  var body, i, item, length, range, result;
...
exports['callByThis'] = function(exp, env) {
  ...
  return convert([['attribute!', caller, 'call'], ['this'].concat(args)], env);
};
