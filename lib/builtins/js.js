var LIST, SYMBOL, VALUE, begin, binary, binaryConverters, call, convert, convertEllipsisRange, convertForInOf, convertHash, convertInterpolatedString, convertList, ellipsisIndex, ellipsisStopOp, error, idBinaryConvert, identifierCharSet, isArray, op, prefix, pushExp, str, suffix, symbol, undefinedExp, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;

_ref = require('../utils'), isArray = _ref.isArray, error = _ref.error, begin = _ref.begin, undefinedExp = _ref.undefinedExp, pushExp = _ref.pushExp, identifierCharSet = _ref.identifierCharSet, str = _ref.str;

_ref1 = '../constant', SYMBOL = _ref1.SYMBOL, VALUE = _ref1.VALUE, LIST = _ref1.LIST;

_ref2 = require('../compiler'), convertList = _ref2.convertList, convert = _ref2.convert;
...
exports["string!"] = convertInterpolatedString = function(exp, env) {
  var e, piece, result, x, xValue0, _len5, _n, _ref8;
  result = ['string!'];
  piece = '""';
  _ref8 = exp.slice(1);
  for (_n = 0, _len5 = _ref8.length; _n < _len5; _n++) {
    ...
    if (x.kind === VALUE && x.value[0] === '"') {
      ...
      if (x.kind === LIST) {
        if ((xValue0 = x.value[0]).kind === SYMBOL && xValue0.value === 'string!') {
          result.push.apply(result, x.value.slice(1));
        } else {
          result.push(x);
        }
      } else {
