...
exports['index!'] = function(exp, env) {
  var eExp1, exp2, exp20;
  exp2 = exp[2];
  exp20 = entity(exp2[0]);
  if (Object.prototype.toString.call(exp2) === '[object Array]') {
    if (exp20 === '...' || exp20 === '..') {
  ...
  } else if ((eExp1 = entity(exp2)) === '..' || eExp1 === '...') {
...
for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
  ...
  binaryConverters['='] = function(op, left, right, env) {
    return [norm('='), convert(left, env), convert(right, env)];
  };
}
...
for (_k = 0, _len2 = _ref4.length; _k < _len2; _k++) {
  ...
  binaryConverters[op] = function(op, left, right, env) {
    return [norm('binary!'), op, convert(left, env), convert(right, env)];
  };
}
