var begin, binaryConverters, commaList, compileError, convert, convertAssign, convertList, extend, isArray, isSymbol, log, prefixConverters, quasiquote, return_, splitSpace, str, symbol, symbolOf, trace, undefinedExp, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;

_ref = require('../utils'), str = _ref.str, log = _ref.log, trace = _ref.trace, begin = _ref.begin, extend = _ref.extend, splitSpace = _ref.splitSpace, undefinedExp = _ref.undefinedExp, symbolOf = _ref.symbolOf, commaList = _ref.commaList, isArray = _ref.isArray, isSymbol = _ref.isSymbol, return_ = _ref.return_;
...
exports['x++'] = function(exp, env) {
  var left, obj, t;
  if (isArray(exp[1]) && symbolOf(exp[1][0]) === 'attribute!') {
    t = env.newVar('t');
    obj = exp[1][1];
    left = ['attribute!', t, exp[1][2]];
    return ['begin!', ['var', t], ['=', t, obj], ['=', left, ['binary!', '+', left, 1]]];
  } else if (isSymbol(exp[1])) {
    return convert(['=', exp[1], ['binary!', '+', exp[1], 1]]);
  }
};
...
for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
  ...
  exports[symbol] = function(exp, env) {
    return ['binary!', exp[0], convert(exp[1], env), convert(exp[2], env)];
  };
}
...
exports['attribute!'] = function(exp, env) {
  return ['attribute!', convert(exp[1], env), exp[2]];
};
...
exports['print'] = function(exp, env) {
  return ['call!', ['attribute!', 'console', 'log'], convertList(exp[1], env)];
};
