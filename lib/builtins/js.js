var begin, binaryConverters, commaList, compileError, convert, convertAssign, convertList, extend, isArray, isSymbol, prefixConverters, quasiquote, return_, splitSpace, str, symbol, symbolOf, trace, undefinedExp, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;

_ref = require('../utils'), str = _ref.str, trace = _ref.trace, begin = _ref.begin, extend = _ref.extend, splitSpace = _ref.splitSpace, undefinedExp = _ref.undefinedExp, symbolOf = _ref.symbolOf, commaList = _ref.commaList, isArray = _ref.isArray, isSymbol = _ref.isSymbol, return_ = _ref.return_;
