...
exports["string!"] = convertInterpolatedString = function(exp, env) {
  var e, piece, result, x, xValue0, _len5, _n, _ref7;
  result = ['string!'];
  piece = '""';
  _ref7 = exp.slice(1);
  for (_n = 0, _len5 = _ref7.length; _n < _len5; _n++) {
