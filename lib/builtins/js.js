var begin, binary, call, convert, convertEllipsisRange, convertForInOf, convertHash, convertInterpolatedString, convertList, ellipsisIndex, ellipsisStopOp, entity, error, identifierCharSet, isArray, prefix, pushExp, suffix, symbol, undefinedExp, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;

_ref = require('../utils'), isArray = _ref.isArray, error = _ref.error, entity = _ref.entity, begin = _ref.begin, undefinedExp = _ref.undefinedExp, pushExp = _ref.pushExp;
...
exports['forOf!!'] = function(exp, env) {
  var body, key, key1, length, obj, vObj, value;
