__slice = [].slice;
var Parser, addPrelude, argumentsLength, begin, compileExp, convert, convertAssign, convertAssignRight, convertDefinition, convertEllipsisList, convertExps, convertIdentifier, convertList, convertMacro, convertMetaExp, convertParametersWithEllipsis, convertParserAttribute, convertParserExpression, declareVar, entity, error, extend, fs, idConvert, isArray, keywordConvert, makeSlice, metaIndex, metaProcess, metaProcessConvert, quasiquote, splitSpace, sym, transformToCode, undefinedExp, _fn, _i, _len, _ref, _ref1, _ref2;

fs = require('fs');

_ref = require('../utils'), convertIdentifier = _ref.convertIdentifier, entity = _ref.entity, begin = _ref.begin, error = _ref.error, isArray = _ref.isArray, error = _ref.error, extend = _ref.extend, splitSpace = _ref.splitSpace, undefinedExp = _ref.undefinedExp, addPrelude = _ref.addPrelude;
...
exports['letloop!'] = function(exp, env) {
  var binding, bindings, exp0, fnBodyEnv, fnScope, i, newEnv, p, p1, params, result, scope, value, x, x0, _i, _len;
  newEnv = env.extend(scope = {});
  result = [];
  exp0 = exp[0];
