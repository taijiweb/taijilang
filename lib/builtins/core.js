...
convertDefinition = function(exp, env, mode) {
  var body, defaultList, ellipsis, exp0, exp1, i, newEnv, param, param1, params, result, scope, thisParams, _i, _len, _this;
