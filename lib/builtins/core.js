__slice = [].slice;
var Parser, TaijiModule, addPrelude, argumentsLength, begin, compileExp, convert, convertAssign, convertAssignRight, convertDefinition, convertEllipsisList, convertExps, convertIdentifier, convertList, convertMacro, convertParametersWithEllipsis, convertParserAttribute, convertParserExpression, declareVar, entity, error, extend, fs, idConvert, isArray, keywordConvert, makeSlice, metaIndex, metaProcessConvert, parser, quasiquote, return_, splitSpace, sym, tjModule, transformToCode, undefinedExp, _fn, _fn1, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
...
_ref1 = require('../compiler'), convert = _ref1.convert, convertList = _ref1.convertList, convertEllipsisList = _ref1.convertEllipsisList, convertExps = _ref1.convertExps, compileExp = _ref1.compileExp, transformToCode = _ref1.transformToCode, metaProcessConvert = _ref1.metaProcessConvert;
...
_fn1 = function(sym) {
  return exports[sym] = function(exp, env) {
    return convertMacro(exp, env, sym);
  };
};
for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
  sym = _ref3[_j];
...
exports['quasiquote!'] = quasiquote = function(exp, env) {
  var e, exp0, head, meetSplice, result, _k, _len2, _ref4;
  exp0 = exp[0];
  if (!isArray(exp0)) {
...
exports['##'] = function(exp, env) {
  return metaProcessConvert(['##', exp[0]], env);
};
...
convertParserExpression = function(exp) {
  var e, i, result, _k, _len2;
  if (Object.prototype.toString.call(exp) === '[object Array]') {
    for (i = _k = 0, _len2 = exp.length; _k < _len2; i = ++_k) {
      e = exp[i];
