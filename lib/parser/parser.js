var BEGIN, BINARY, BRACKET, BREAK, COMPACT_CLAUSE_EXPRESSION, CONJUNCTION, CONTINUE, CURVE, EOI, FORIN, FOROF, HALF_DENT, IDENTIFIER, IF, INDENT, KEYWORD, LINE_COMMENT, NEW, NEWLINE, NULL, NUMBER, OPERATOR_EXPRESSION, PAREN, PREFIX, PUNCTUATION, REGEXP, RETURN, RIGHT_DELIMITER, SHARP, SPACE, SPACES, SPACE_COMMENT, STRING, SUFFIX, SYMBOL, TAIL_COMMENT, THROW, TRY, UNDEFINED, UNDENT, WHILE, begin, binaryOperatorDict, conjMap, conjunctionHasOwnProperty, extend, firstIdentifierCharSet, firstSymbolCharset, hasOwnProperty, keywordHasOwnProperty, keywordMap, letterCharSet, prefixOperatorDict, str, taijiIdentifierCharSet, trace, _ref, _ref1, _ref2,
  __slice = [].slice;

_ref = require('../utils'), str = _ref.str, hasOwnProperty = _ref.hasOwnProperty, extend = _ref.extend, letterCharSet = _ref.letterCharSet, firstIdentifierCharSet = _ref.firstIdentifierCharSet, firstSymbolCharset = _ref.firstSymbolCharset, taijiIdentifierCharSet = _ref.taijiIdentifierCharSet, trace = _ref.trace;

_ref1 = require('../constant'), NULL = _ref1.NULL, NUMBER = _ref1.NUMBER, STRING = _ref1.STRING, IDENTIFIER = _ref1.IDENTIFIER, SYMBOL = _ref1.SYMBOL, REGEXP = _ref1.REGEXP, PUNCTUATION = _ref1.PUNCTUATION, PAREN = _ref1.PAREN, BRACKET = _ref1.BRACKET, CURVE = _ref1.CURVE, NEWLINE = _ref1.NEWLINE, SPACES = _ref1.SPACES, LINE_COMMENT = _ref1.LINE_COMMENT, EOI = _ref1.EOI, INDENT = _ref1.INDENT, UNDENT = _ref1.UNDENT, HALF_DENT = _ref1.HALF_DENT, SPACE_COMMENT = _ref1.SPACE_COMMENT, TAIL_COMMENT = _ref1.TAIL_COMMENT, SPACE = _ref1.SPACE, RIGHT_DELIMITER = _ref1.RIGHT_DELIMITER, KEYWORD = _ref1.KEYWORD, CONJUNCTION = _ref1.CONJUNCTION, PREFIX = _ref1.PREFIX, SUFFIX = _ref1.SUFFIX, BINARY = _ref1.BINARY, COMPACT_CLAUSE_EXPRESSION = _ref1.COMPACT_CLAUSE_EXPRESSION, OPERATOR_EXPRESSION = _ref1.OPERATOR_EXPRESSION, UNDEFINED = _ref1.UNDEFINED, BEGIN = _ref1.BEGIN, IF = _ref1.IF, PREFIX = _ref1.PREFIX, SUFFIX = _ref1.SUFFIX, BINARY = _ref1.BINARY, WHILE = _ref1.WHILE, BREAK = _ref1.BREAK, CONTINUE = _ref1.CONTINUE, THROW = _ref1.THROW, RETURN = _ref1.RETURN, NEW = _ref1.NEW, FORIN = _ref1.FORIN, FOROF = _ref1.FOROF, TRY = _ref1.TRY, SHARP = _ref1.SHARP;
