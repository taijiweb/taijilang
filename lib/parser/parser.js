var BEGIN, BINARY, BRACKET, BRACKET_PAIR, BREAK, COMPACT_CLAUSE_EXPRESSION, CONJUNCTION, CONTINUE, CURVE, CURVE_PAIR, EOI, FORIN, FOROF, HALF_DENT, IDENTIFIER, IF, INDENT, KEYWORD, LINE_COMMENT, NEW, NEWLINE, NULL, NUMBER, OPERATOR_EXPRESSION, PAREN, PAREN_PAIR, PREFIX, PUNCTUATION, REGEXP, RETURN, RIGHT_DELIMITER, SHARP, SPACE, SPACES, SPACE_COMMENT, STRING, SUFFIX, SYMBOL, TAIL_COMMENT, THROW, TRY, UNDEFINED, UNDENT, VALUE, WHILE, begin, binaryOperatorDict, conjMap, conjunctionHasOwnProperty, extend, firstIdentifierCharSet, firstSymbolCharset, hasOwnProperty, keywordHasOwnProperty, keywordMap, letterCharSet, prefixOperatorDict, str, symbol, taijiIdentifierCharSet, trace, _ref, _ref1, _ref2,
  __slice = [].slice;

_ref = require('../utils'), str = _ref.str, hasOwnProperty = _ref.hasOwnProperty, extend = _ref.extend, letterCharSet = _ref.letterCharSet, firstIdentifierCharSet = _ref.firstIdentifierCharSet, firstSymbolCharset = _ref.firstSymbolCharset, taijiIdentifierCharSet = _ref.taijiIdentifierCharSet, trace = _ref.trace, symbol = _ref.symbol;
