...
exports.Parser = function() {
  ...
  this.regexp = memo(function() {
    var c, i, indentColumn, start;
    if (text[start = cursor] !== '/') {
      return;
    }
    if (cursor === (indentColumn = lineInfo[lineno].indentColumn)) {
      return;
    }
    c = text[cursor + 1];
    if (c === '*' || c === '/') {
  ...
  this.dataBracket = memo(function() {
    var indentColumn, line1, result, space, start, x;
    start = cursor;
    line1 = lineno;
    indentColumn = lineInfo[lineno].indentColumn;
    if (text.slice(cursor, cursor + 2) !== '[\\') {
  ...
  this.hashBlock = memo(function() {
    var c, column, column1, indentColumn, line1, result, space, space2, start, x;
    start = cursor;
    line1 = lineno;
  ...
  this.expectIndentConj = expectIndentConj = function(word, line1, isHeadStatement, options, clauseFn) {
    var column, indentColumn, line2, meetWord, optionalClause, optionalWord, space, start2, w;
    start2 = cursor;
    line2 = lineno;
  ...
  this.identifierList = function() {
    var column, indentColumn, line1, result, row0, space, varList;
    line1 = lineno;
    indentColumn = lineInfo[line1].indentColumn;
  ...
  this.varInitList = function() {
    var column, indentColumn0, indentColumn1, line1, result, space, space1, start, x;
    start = cursor;
    line1 = lineno;
    result = [];
  ...
  this.makeAssignClause = function(assignLeftSide, assignSymbol, assignRightSide) {
    return function() {
      var eLeft, left, line1, right, space, start, token;
      start = cursor;
      line1 = lineno;
  ...
  this.blockWithoutIndentHead = function() {
    var indentColumn, result, space, x, x0;
    indentColumn = lineInfo[lineno].indentColumn;
    result = [];
  ...
  this.dataBlock = function() {
    var indentColumn, result, space, x;
    indentColumn = lineInfo[lineno].indentColumn;
    result = [];
    space = bigSpc();
    while ((x = parser.dataLine()) && (space = bigSpc())) {
