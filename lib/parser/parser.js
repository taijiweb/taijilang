...
exports.Parser = function() {
  ...
  this.clause = function() {
    var blk, clause, clauses, definition, exp, head, isStatementHead, op, opToken, params, result, right, start, tkn, tokenAfterOperator, type, value;
    if (tokenType === SPACE) {
      nextToken();
      type = tokenType;
    }
