...
exports.Parser = function() {
  ...
  binaryDictOperator = function(mode, x) {
    var op, opToken, opValue, pri, priInc, start, txt2, type, type1;
    start = token;
  ...
  this.binaryPrototypeAttributeOperator = function(mode, x) {
    var cur;
    if ((x.type === IDENTIFIER || x.text === '@') && token.value === '::') {
      return {
        symbol: 'attribute!',
        type: SYMBOL,
        start: cursor,
  ...
  this.customBinaryOperator = function(mode, x) {
    var fn, op, _k, _len2, _ref5;
    _ref5 = parser.customBinaryOperators;
