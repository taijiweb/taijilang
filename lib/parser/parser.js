...
exports.Parser = function() {
  ...
  this.keyword2statement = keyword2statement = {
    ...
    'import!': function(isHeadStatement) {
      var alias, alias2, from_, item, items, metaAlias, metaImportList, parseMethod, runtimeImportList, srcModule, sym2, symValue, x, _len4, _len5, _m, _n;
      if (token.type === SPACE) {
        nextToken();
      }
