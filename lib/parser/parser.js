...
exports.Parser = function() {
  var atStatementHead, breakContinueStatement, c, char, cursor, definitionSymbolBody, eoi, expectThen, expression, fn, identifierCharSet, indent, isNewlineChar, key, keyword2statement, keywordThenElseStatement, leadTokenClause, leadWordClauseMap, leftRegexp, lexIndent, lineStart, lineno, matchToken, maybeConjunction, newLineAndEmptyLines, nextNonspaceToken, nextPiece, nextToken, nullToken, operatorExpression, parseError, parser, rollbackOnType, setToken, skipInlineSpace, skipNewline, skipSPACE, skipSomeType, skipSpaceLines, skipTokenType, sym, symbol2clause, symbolStopChars, text, textLength, throwReturnStatement, token, tokenFnMap, tokenOnBackSlashChar, tokenOnForwardSlashChar, tokenOnIdentifierChar, tokenOnLeftBracketChar, tokenOnNewlineChar, tokenOnNumberChar, tokenOnQuoteChar, tokenOnRightDelimiterChar, tokenOnSymbolChar, tokenType, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref2, _ref3, _ref4, _ref5, _ref6;
  parser = this;
  text = '';
  ...
  this.prefixOperator = function(mode) {
    ...
    if (mode === COMPACT_CLAUSE_EXPRESSION && op.definition) {
      return;
    }
    opToken = token;
    nextToken();
