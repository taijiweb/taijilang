...
exports.Parser = function() {
  var atLineHead, atStatementHead, binaryOperatorMemoIndex, bracketVariantMap, breakContinueStatement, c, caseClauseOfSwitchStatement, catchClause, char, concatenateLine, concatenating, conjClause, cursor, curveVariantMap, decimal, elseClause, endCursorOfDynamicBlockStack, environment, eoi, error, expect, expectChar, expectIdentifier, expectIndentConj, expectOneOfWords, expectWord, expression, expressionMemoIndex, finallyClause, follow, followMatch, followSequence, hashBlock, hashItem, hashLine, hashLineBlock, indent, indentExpression, interolateStringNumber, isCallable, isIdentifier, itemToParameter, key, keywordTestExpressionBodyStatement, keywordThenElseStatement, leadTokenClause, leadWordClauseMap, leftCBlockComment, leftIndentBlockComment, leftInterpolateString, leftNonInterpolatedString, leftRawInterpolateString, leftRawNonInterpolatedString, leftRegexp, letLikeStatement, lexError, lexIndent, lineStart, lineno, literal, matchChar, matchToken, maybeOneOfWords, memoIndex, memoMap, newLineAndEmptyLines, newline, nextToken, nonInterpolatedStringLine, operatorExpression, parenVariantMap, parser, predefined, rawNonInterpolatedStringLine, seperatorList, skipInlineSpace, skipSpaceLines, spaceClauseExpression, spaceComma, spaces, symbol2clause, symbolStopChars, text, thenClause, throwReturnStatement, toParameters, token, tokenFnMap, tokenOnAtChar, tokenOnBackSlashChar, tokenOnColonChar, tokenOnCommaChar, tokenOnDoubleQuoteChar, tokenOnForwardSlashChar, tokenOnIdentifierChar, tokenOnLeftBracketChar, tokenOnLeftParenChar, tokenOnNewlineChar, tokenOnNumberChar, tokenOnRightDelimiterChar, tokenOnSemiColonChar, tokenOnSingleQuoteChar, tokenOnSpaceChar, tokenOnSymbolChar, unchangeable, word, _i, _j, _len, _len1, _ref3, _ref4;
  parser = this;
  ...
  this.sentence = function() {
    ...
    start = token;
    if ((type = token.type) === EOI || type === UNDENT || type === NEWLINE || type === RIGHT_DELIMITER || isConjunction(token)) {
      return;
    }
