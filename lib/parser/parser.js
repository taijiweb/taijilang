...
exports.Parser = function() {
  ...
  keywordThenElseStatement = function(keyword) {
    return function(isHeadStatement) {
      ...
      if (else_) {
        result = [keyword, test, then_, else_];
      } else {
        result = [keyword, test, then_];
      }
      result.start = start;
      result.stop = token;
      return result;
  ...
  this.keyword2statement = keyword2statement = {
    ...
    'do': function(isHeadStatement) {
      ...
      if (conjValue === 'where') {
        ...
        return {
          value: ['doWhile!', body, ['prefix', '!', tailClause]],
          start: start,
          stop: token
        };
      }
    ...
    'switch': function(isHeadStatement) {
      ...
      result = ['switch', test, cases, else_];
      result.start = start;
      result.stop = token;
      return result;
    },
    'try': function(isHeadStatement) {
      ...
      result = ['try', test, catchVar, catch_, final];
      result.start = start;
      result.stop = token;
      return result;
    },
    'class': function(isHeadStatement) {
      ...
      result = ['#call!', 'class', [name, superClass, body]];
      result.start = start;
      result.stop = token;
      return result;
    }
