...
exports.Parser = function() {
  ...
  this.atom = function(mode) {
    ...
    if (mode !== 'inStrExp' && (x = parser.string())) {
      x.priority = 1000;
    } else if (x = parser.identifier() || parser.number() || parser.regexp() || parser.delimiterExpression() || parser.escapeSymbol()) {
      x.priority = 1000;
  ...
  this.colonClause = memo(function() {
    var line1, result, space, start, x;
    start = cursor;
    line1 = lineno;
