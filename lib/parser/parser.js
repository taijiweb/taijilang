    ...
    return function() {
      ...
      if (left.type === CURVE) {
        ...
        if (typeof eLeft === 'string') {
          ...
          if (eLeft[0] === 'begin!') {
            error('syntax error: left side of assign should be a list of variable names separated by spac');
          }
        } else {
