var Environment, Parser, TaijiModule, addPrelude, begin, compile, compileExp, compileExpNoOptimize, compileInteractive, entity, ext, extend, formatTaijiJson, initEnv, metaConvert, optimizeExp, rootModule, textizerOptions, transformExp, _base, _i, _len, _ref, _ref1, _ref2;

exports.VERSION = '0.1.0';

_ref = require('./utils'), extend = _ref.extend, begin = _ref.begin, formatTaijiJson = _ref.formatTaijiJson, addPrelude = _ref.addPrelude;

TaijiModule = require('./module');

Parser = require('./parser').Parser;

entity = require('./parser/base').entity;

exports.Parser = Parser;

_ref1 = require('./compiler'), Environment = _ref1.Environment, metaConvert = _ref1.metaConvert, transformExp = _ref1.transformExp, optimizeExp = _ref1.optimizeExp, compileExp = _ref1.compileExp, compileExpNoOptimize = _ref1.compileExpNoOptimize;
