...
AssignIncludeVars = function(moduleVar, env) {
  var exportVar;
  exportVar = ['metaConvertVar!', 'name'];
  return ['begin!', ['var', exportVar], ['forOf!', exportVar, moduleVar, ['if', ['call!', ['attribute!', '__hasProp', 'call'], [exportVar]], ['=', exportVar, ['index!', moduleVar, exportVar]]]]];
};

metaConvertInclude = function(exp, metaExpList, env) {
  var assignList, moduleVar, newEnv, _ref1;
  ...
  return exp = begin([wrapMetaObjectFunctionCall(exp, metaExpList, env, void 0, void 0), assignList, metaConvert(assignList, metaExpList, env)]);
};
...
isMetaOperation = function(head) {
  return head[0] === '#' || head === 'include!' || head === 'import!';
};
