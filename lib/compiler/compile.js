  ...
  if (tail.concated) {
    if (head && head.push && ((head0 = head[0]) === 'attribute!' || head0 === 'index!')) {
      ...
      if (typeof h1 === 'string' && h1[0] !== '"') {
        return norm(['call!', ['attribute!', head, 'apply'], [h1, tail]]);
      } else {
