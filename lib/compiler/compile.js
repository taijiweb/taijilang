var $atMetaExpList, BLOCK_COMMENT, BRACKET, CODE_BLOCK_COMMENT, CONCAT_LINE, CURVE, DATA_BRACKET, Environment, FUNCTION, HALF_DENT, HEAD_SPACES, IDENTIFIER, INDENT, INDENT_EXPRESSION, INLINE_COMMENT, INTERPOLATE_STRING, LINE_COMMENT, LIST, MODULE, MODULE_HEADER, NEWLINE, NON_INTERPOLATE_STRING, NUMBER, PAREN, PUNCT, Parser, REGEXP, SPACES, SPACES_INLINE_COMMENT, STRING, SYMBOL, TaijiModule, UNDENT, VALUE, analyze, begin, compileError, compileExp, compileExpNoOptimize, convert, convertArgumentList, convertExps, doAnalyze, entity, evaljs, exportsIndex, extend, extendSyntaxInfo, formatTaijiJson, fs, getStackTrace, hasMeta, include, includeModuleFunctionCall, isArray, madeCall, madeConcat, metaCompile, metaConvert, metaConvertExport, metaConvertFnMap, metaConvertImport, metaInclude, metaProcess, metaTransform, nonMetaCompileExp, nonMetaCompileExpNoOptimize, optimize, optimizeExp, parseModule, parser, path, preprocessMetaConvertFnMap, pushExp, str, symbolLookupError, taijiExports, tocode, trace, transform, transformExp, transformToCode, undefinedExp, wrapInfo1, wrapMetaObjectFunctionCall, wrapModuleFunctionCall, __TJ__QUOTE, _ref, _ref1, _ref2;
...
_ref1 = require('../utils'), evaljs = _ref1.evaljs, isArray = _ref1.isArray, extend = _ref1.extend, str = _ref1.str, formatTaijiJson = _ref1.formatTaijiJson, wrapInfo1 = _ref1.wrapInfo1, extendSyntaxInfo = _ref1.extendSyntaxInfo, entity = _ref1.entity, pushExp = _ref1.pushExp, undefinedExp = _ref1.undefinedExp, begin = _ref1.begin, __TJ__QUOTE = _ref1.__TJ__QUOTE, trace = _ref1.trace;

_ref2 = '../constant', NUMBER = _ref2.NUMBER, STRING = _ref2.STRING, IDENTIFIER = _ref2.IDENTIFIER, SYMBOL = _ref2.SYMBOL, REGEXP = _ref2.REGEXP, HEAD_SPACES = _ref2.HEAD_SPACES, CONCAT_LINE = _ref2.CONCAT_LINE, PUNCT = _ref2.PUNCT, FUNCTION = _ref2.FUNCTION, BRACKET = _ref2.BRACKET, PAREN = _ref2.PAREN, DATA_BRACKET = _ref2.DATA_BRACKET, CURVE = _ref2.CURVE, INDENT_EXPRESSION = _ref2.INDENT_EXPRESSION, NEWLINE = _ref2.NEWLINE, SPACES = _ref2.SPACES, INLINE_COMMENT = _ref2.INLINE_COMMENT, SPACES_INLINE_COMMENT = _ref2.SPACES_INLINE_COMMENT, LINE_COMMENT = _ref2.LINE_COMMENT, BLOCK_COMMENT = _ref2.BLOCK_COMMENT, CODE_BLOCK_COMMENT = _ref2.CODE_BLOCK_COMMENT, CONCAT_LINE = _ref2.CONCAT_LINE, MODULE_HEADER = _ref2.MODULE_HEADER, MODULE = _ref2.MODULE, NON_INTERPOLATE_STRING = _ref2.NON_INTERPOLATE_STRING, INTERPOLATE_STRING = _ref2.INTERPOLATE_STRING, INDENT = _ref2.INDENT, UNDENT = _ref2.UNDENT, HALF_DENT = _ref2.HALF_DENT, VALUE = _ref2.VALUE, LIST = _ref2.LIST;
  ...
  if (exp instanceof Array) {
    ...
    if (exp0 instanceof Array) {
      ...
      if (typeof head === 'function') {
        ...
        tail = convertArgumentList(expValue.slice(1), env);
        return madeCall(head, tail, env);
      }
    } else {
      return (function() {
...
exports.convertArgumentList = convertArgumentList = function(exp, env) {
  var concated, concating, e, e1, ee1, ellipsis, exp0, exp01, i, item, piece, result, _i, _j, _len, _len1, _ref3;
  if (exp.length === 0) {
    return ['list!'];
  }
  if (exp.length === 1) {
    if ((exp0 = exp[0]) && exp0[0] && exp0[0].value === 'x...') {
      return convert(exp0[0][1], env);
    }
