var $atMetaExpList, BLOCK_COMMENT, BRACKET, CODE_BLOCK_COMMENT, CONCAT_LINE, CURVE, CompileError, DATA_BRACKET, Environment, FUNCTION, HALF_DENT, HEAD_SPACES, IDENTIFIER, INDENT, INDENT_EXPRESSION, INLINE_COMMENT, INTERPOLATE_STRING, LINE_COMMENT, LIST, MODULE, MODULE_HEADER, NEWLINE, NON_INTERPOLATE_STRING, NUMBER, PAREN, PUNCT, Parser, REGEXP, SPACES, SPACES_INLINE_COMMENT, STRING, SYMBOL, TaijiModule, UNDENT, VALUE, analyze, begin, compileExp, compileExpNoOptimize, constant, convert, convertArgumentList, convertExps, doAnalyze, entity, evaljs, exportsIndex, extend, formatTaijiJson, fs, getStackTrace, hasMeta, include, includeModuleFunctionCall, isArray, madeCall, madeConcat, metaCompile, metaConvert, metaConvertExport, metaConvertFnMap, metaConvertImport, metaInclude, metaProcess, metaTransform, nonMetaCompileExp, nonMetaCompileExpNoOptimize, optimize, optimizeExp, parseModule, parser, path, preprocessMetaConvertFnMap, pushExp, str, taijiExports, tocode, transform, transformExp, transformToCode, undefinedExp, wrapInfo1, wrapMetaObjectFunctionCall, wrapModuleFunctionCall, __TJ__QUOTE, _ref,
...
_ref = require('../utils'), evaljs = _ref.evaljs, isArray = _ref.isArray, extend = _ref.extend, str = _ref.str, formatTaijiJson = _ref.formatTaijiJson, wrapInfo1 = _ref.wrapInfo1, entity = _ref.entity, pushExp = _ref.pushExp, undefinedExp = _ref.undefinedExp, begin = _ref.begin, __TJ__QUOTE = _ref.__TJ__QUOTE, constant = _ref.constant;
...
exports.CompileError = CompileError = (function(_super) {
  __extends(CompileError, _super);

  function CompileError(exp, message) {
    this.exp = exp;
