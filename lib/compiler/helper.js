var COMMAND, LIST, SYMBOL, VALUE, assignVarsOf, compileError, constant, extend, pollutedOf, str, symbolLookupError, trace, varsOf, _ref;

_ref = require('../utils'), constant = _ref.constant, extend = _ref.extend, str = _ref.str, trace = _ref.trace;
