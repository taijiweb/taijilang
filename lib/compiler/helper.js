var COMMAND, LIST, SYMBOL, VALUE, assignVarsOf, compileError, extend, pollutedOf, str, symbolLookupError, trace, varsOf, _ref, _ref1;

_ref = require('../utils'), extend = _ref.extend, str = _ref.str, trace = _ref.trace;

_ref1 = require('../constant'), VALUE = _ref1.VALUE, SYMBOL = _ref1.SYMBOL, LIST = _ref1.LIST, COMMAND = _ref1.COMMAND;
...
exports.symbolLookupError = symbolLookupError = function(symbol, exp, message) {
  if (message) {
    throw new Error(message + ': ' + symbol.value + ': ' + str(exp));
  } else {
    throw new Error('symbol lookup error: ' + symbol.value + ': ' + str(exp));
  }
};
