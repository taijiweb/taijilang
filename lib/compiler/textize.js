var SYMBOL, TKN_BINARY, TKN_BLOCK, TKN_BRACKET, TKN_CLAUSE, TKN_COMPOUND, TKN_CURVE, TKN_FUNCTION, TKN_INDENT, TKN_LINE, TKN_LIST, TKN_MAYBE, TKN_PAREN, TKN_SEQUENCE, TKN_STATEMENT, TKN_STATEMENT_LIST, TKN_UNDENT, TKN_VALUE, TKN_WRAP_BLOCK, TokenizeError, VALUE, assert, begin, binary, binaryPriority, block, bracket, charset, clause, compound, curve, digitCharSet, extend, func, headSymbol, identifierCharSet, ind, indentToken, isArray, isObject, isValue, letterCharSet, line, list, makeTextizer, maybe, paren, priority, sequence, setFunction, statement, statementList, str, tokenFnMap, tokenNameMap, tokenize, tokenizeError, trace, unaryPriority, und, undefinedExp, undentToken, wrapBlock, _ref, _ref1,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __slice = [].slice;

_ref = require('../utils'), str = _ref.str, isArray = _ref.isArray, extend = _ref.extend, charset = _ref.charset, begin = _ref.begin, undefinedExp = _ref.undefinedExp, isValue = _ref.isValue, digitCharSet = _ref.digitCharSet, letterCharSet = _ref.letterCharSet, identifierCharSet = _ref.identifierCharSet, assert = _ref.assert, trace = _ref.trace, headSymbol = _ref.headSymbol, isObject = _ref.isObject;
...
tokenFnMap = {
  ...
  'begin!': function(exp) {
    return statementList(exp.slice(1));
  },
