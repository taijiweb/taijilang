var LIST, SYMBOL, TKN_BINARY, TKN_BLOCK, TKN_BRACKET, TKN_CLAUSE, TKN_COMPOUND, TKN_CURVE, TKN_FUNCTION, TKN_INDENT, TKN_LINE, TKN_LIST, TKN_MAYBE, TKN_PAREN, TKN_SEQUENCE, TKN_STATEMENT, TKN_STATEMENT_LIST, TKN_UNDENT, TKN_VALUE, TKN_WRAP_BLOCK, TokenizeError, VALUE, assert, begin, binary, binaryPriority, block, bracket, charset, clause, compound, curve, digitCharSet, extend, func, identifierCharSet, ind, indentToken, isArray, isValue, letterCharSet, line, list, makeTextizer, maybe, paren, priority, sequence, setFunction, statement, statementList, str, tokenFnMap, tokenNameMap, tokenize, tokenizeError, trace, unaryPriority, und, undefinedExp, undentToken, wrapBlock, _ref, _ref1,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __slice = [].slice;

_ref = require('../utils'), str = _ref.str, isArray = _ref.isArray, extend = _ref.extend, charset = _ref.charset, begin = _ref.begin, undefinedExp = _ref.undefinedExp, isValue = _ref.isValue, digitCharSet = _ref.digitCharSet, letterCharSet = _ref.letterCharSet, identifierCharSet = _ref.identifierCharSet, assert = _ref.assert, trace = _ref.trace;

_ref1 = '../constant', SYMBOL = _ref1.SYMBOL, VALUE = _ref1.VALUE, LIST = _ref1.LIST;
...
tokenFnMap = {
  ...
  'var': function(exp) {
    var assigns, e, meetFirst, result, t, _i, _j, _len, _len1, _ref2;
  ...
  'begin!': function(exp) {
    var e, e1, e1Value, eValue, eValue0, eValue1Value, exps, _i, _len, _ref2;
