var Environment, SYMBOL, assert, constant, entity, extend, hasOwnProperty, identifierCharSet, javascriptKeywordSet, str, toIdentifier, _ref;
...
exports.Environment = Environment = (function() {
  ...
  Environment.prototype.get = function(symbol) {
    ...
    while (env) {
      scope = env.scope;
      if (hasOwnProperty.call(scope, symbol)) {
        return scope[symbol];
      }
      env = env.parent;
    }
