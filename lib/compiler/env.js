var Environment, SymbolLookupError, error, extend, hasOwnProperty, identifierCharSet, javascriptKeywordSet, toIdentifier, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

_ref = require('../utils'), extend = _ref.extend, javascriptKeywordSet = _ref.javascriptKeywordSet;
...
exports.Environment = Environment = (function() {
  ...
  Environment.prototype.getDefinitionExpListEnv = function() {
    var env;
    env = this;
    while (!env.definitionExpList) {
      env = env.parent;
    }
    return env;
  };
