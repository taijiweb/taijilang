var Environment, SYMBOL, assert, entity, extend, hasOwnProperty, identifierCharSet, javascriptKeywordSet, str, toIdentifier, _ref;

_ref = require('../utils'), extend = _ref.extend, str = _ref.str, javascriptKeywordSet = _ref.javascriptKeywordSet, entity = _ref.entity, identifierCharSet = _ref.identifierCharSet, assert = _ref.assert;

SYMBOL = require('../constant').SYMBOL;
