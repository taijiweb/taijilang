var ATTR, BEGIN, BINARY, BRACKET_PAIR, BREAK, CALL, CONTINUE, CURVE_PAIR, FORIN, FOROF, IF, INDEX, NEW, PAREN_PAIR, PREFIX, RETURN, SHARP, SUFFIX, SYMBOL, THROW, TRY, UNDEFINED, WHILE, addBeginItem, assert, begin, charset, commaList, digitCharSet, digits, error, firstIdentifierChars, firstSymbolChars, formatTaijiJson, fs, identifierCharSet, identifierChars, isArray, isMetaOperation, isObject, isSymbol, javascriptKeywordSet, javascriptKeywordText, letterCharSet, letterDigits, letters, log, lowers, path, returnFnMap, return_, stackReg, stackReg2, str, symbol, symbolOf, taijiIdentifierCharSet, taijiIdentifierChars, trace, trace0, trace1, trace2, trace3, truth, undefinedExp, uppers, _ref, _trace,
  __slice = [].slice;
