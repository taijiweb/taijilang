var addBeginItem, assert, begin, charset, digitCharSet, digits, error, firstIdentifierChars, firstSymbolChars, formatTaijiJson, fs, identifierCharSet, identifierChars, isArray, isMetaOperation, letterCharSet, letterDigits, letters, log, lowers, path, returnFnMap, return_, stackReg, stackReg2, str, taijiIdentifierCharSet, taijiIdentifierChars, trace, trace0, trace1, trace2, trace3, truth, uppers, _trace,
  __slice = [].slice;
