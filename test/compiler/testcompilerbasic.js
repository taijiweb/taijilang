...
describe("compiler basic: ", function() {
  describe("compile number: ", function() {
    ...
    it("compile 01", function() {
      return expect(compile('01')).to.equal('1');
    });
    it("compile 0x01", function() {
      return expect(compile('0x01')).to.equal('1');
    });
    it("compile 0xa", function() {
      expect(compile('0xa')).to.equal('10');
      return expect(compile('0xa')).to.equal('10');
    });
  ...
  describe("compile string: ", function() {
    describe("compile interpolate string: ", function() {
      it("compile a", function() {
        return expect(compile('"a"')).to.equal("\"a\"");
      });
      it("compile a\\b", function() {
        return expect(compile('"a\\b"')).to.equal("\"a\\b\"");
      });
      it("compile '''a\"'\\n'''", function() {
        return expect(compile('"""a\\"\'\\n"""')).to.equal("\"a\\\"'\\n\"");
      });
      it("compile \"a(1)\" ", function() {
        return expect(compile('"a(1)"')).to.equal("\"a(1)\"");
      });
      it("compile \"a[1]\" ", function() {
        return expect(compile('"a[1]"')).to.equal("\"a[\" + JSON.stringify([1]) + \"]\"");
      });
      return it("compile \"a[1] = $a[1]\" ", function() {
        return expect(compile('var a; "a[1] = $a[1]"')).to.equal("var a;\n\"a[\" + JSON.stringify([1]) + \"] = \" + JSON.stringify(a[1]);");
      });
    });
    describe("compile raw string without interpolation: ", function() {
      it("compile '''a\\b'''", function() {
        return expect(compile("'''a\\b'''")).to.deep.equal("\"a\\b\"");
      });
      it("compile '''a\\b\ncd'''", function() {
  ...
  describe("parenthesis: ", function() {
    it('should compile ()', function() {
      return expect(compile('()')).to.deep.equal('');
    });
  ...
  describe("@ as this", function() {
    it('should compile @', function() {
      return expect(compile('@')).to.deep.equal('this');
    });
    it('should compile @a', function() {
      return expect(compile('@a')).to.deep.equal("this.a");
    });
  ...
  describe(":: as prototype: ", function() {
    it('should compile @:: ', function() {
      return expect(compile('@::')).to.deep.equal("this.prototype");
    });
    it('should compile a:: ', function() {
      return expect(compile('var a; a::')).to.deep.equal("var a;\na.prototype;");
    });
    ...
    return it('should compile ::a', function() {
      return expect(compile('::a')).to.deep.equal("this.prototype.a");
    });
  });
  describe("quote expression:", function() {
    return describe("quote expression:", function() {
      it('should compile ~ a.b', function() {
        return expect(compile('~ a.b')).to.deep.equal("[\"attribute!\",\"a\",\"b\"]");
      });
      it('should compile ~ print a b', function() {
        return expect(compile('~ print a b')).to.deep.equal("[\"print\",\"a\",\"b\"]");
      });
      it('should compile ` print a b', function() {
        return expect(compile('` print a b')).to.deep.equal("[\"print\", \"a\", \"b\"]");
      });
  ...
  describe("unquote expression:", function() {
    describe("unquote expression: ", function() {
      ...
      it('should compile ` ^ [print a b]', function() {
        return expect(compile('var a, b; ` ^ [print a b]')).to.deep.equal("var a, b;\n[console.log(a, b)];");
      });
      it('should compile ` ^ {print a b}', function() {
        return expect(compile('var a, b; ` ^ {print a b}')).to.deep.equal("var a, b;\nconsole.log(a, b);");
      });
  ...
  describe("hash!: ", function() {
    return describe("hash! expression: ", function() {
      ...
      it('should compile {.1:2; 3:4.}', function() {
        return expect(compile('{.1:2; 3:4.}')).to.deep.equal("{ 1: 2, 3: 4}");
      });
  ...
  return describe("block comment ", function() {
    it('should compile /. some comment', function() {
      return expect(compile('/. some comment')).to.deep.equal('');
    });
