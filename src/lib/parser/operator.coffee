...
exports.binaryOperatorDict =
  ...
  'and': {priority: 50}, 'or': {priority: 40}, #'xor': {value: '^', priority: 40}
  ...
  #'or=': {priority:20, value:'or=', rightAssoc: true, assign:true}

#: #=: meta assign, assign meta value or macro to variable
exports.assignOperators = ('= += -= *= /= %= <<= >>= >>>= &= |= ^= &&= ||= #= #/=').split(' ') # #&=
do -> for op in exports.assignOperators
  exports.binaryOperatorDict[op] = {priority:20, value:op, rightAssoc: true, assign:true}
