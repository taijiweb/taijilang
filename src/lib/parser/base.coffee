...
NUMBER=1;  STRING=2;  IDENTIFIER=3; SYMBOL=4; REGEXP=5;  HEAD_SPACES=6; CONCAT_LINE=7; PUNCTUATION=8; FUNCTION=9
...
OPERATOR_EXPRESSION = 43; COMPACT_CLAUSE_EXPRESSION = 44;  SPACE_CLAUSE_EXPRESSION = 45; INDENT_EXPRESSION = 46
END_INTERPOLATED_STRING = 47

exports.constant = {NUMBER, STRING, IDENTIFIER, SYMBOL, REGEXP, HEAD_SPACES, CONCAT_LINE, PUNCTUATION, FUNCTION,
